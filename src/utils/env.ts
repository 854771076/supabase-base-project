...
const envSchema = z.object({
    ...
    NEXT_PUBLIC_TOKENPAY_URL: z.string().url().optional(),
    TOKENPAY_API_KEY: z.string().optional(),
...
const processEnv = {
    ...
    NEXT_PUBLIC_TOKENPAY_URL: process.env.NEXT_PUBLIC_TOKENPAY_URL,
    TOKENPAY_API_KEY: process.env.TOKENPAY_API_KEY,
